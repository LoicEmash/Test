...
Ext.define("AmsMain.view.navigation.tree.node.metier.table.Detail", {
    extend: "Ext.panel.Panel",
    xtype: 'ams-navigation-tree-node-metier-table-detail',
    controller: "navigation-tree-node-metier-table-detail",
    viewModel: {
        type: "navigation-tree-node-metier-table-detail"
    },
    requires: [
        'AmsMain.view.navigation.tree.node.metier.table.DetailController',
        'AmsMain.view.navigation.tree.node.metier.table.DetailModel',

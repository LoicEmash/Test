...
/**
* @ORM\Entity
* @ORM\Table(name="inf.inf_fam_dec")
*/
class InfFamDec
{
	/**
	...
	* @ORM\Id
	* @ORM\SequenceGenerator(sequenceName="inf.inf_fam_dec_id_seq")
	...
	*/
	...
	/**
	*  @ORM\OneToMany(targetEntity="InfCdDec", mappedBy="infFamDec")
	**/
	protected $infCdDecs;
	
	public function __construct() {
	$this->infCdDecs = new \Doctrine\Common\Collections\ArrayCollection();
	}
	...
	public function getInfCdDecs()
	{
		return $this->infCdDecs;
	}
}
